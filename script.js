document.addEventListener('DOMContentLoaded', function() {
    ...
    // Help button navigation for index.html
    ...
    // Help button navigation for you.html
    const helpButtonYou = document.getElementById('helpButtonYou');
    if (helpButtonYou) {
        helpButtonYou.addEventListener('click', function() {
